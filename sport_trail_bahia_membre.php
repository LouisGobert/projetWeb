...
<html lang="fr">
    <head>
        <meta charset="utf-8" />
        <title>TRAIL BAHIA FELIZ | BLUECOW®</title>
    ...
    <body>
      ...
      <h1 class="position">Le trail à Bahia Feliz</h1>
      ...
      <main>
        <section class="conteneur_presen_sport">
          ...
          <article class="sport_detail" id="detail_lieu">
            <h2>Le trail à Bahia Feliz,</h2><p>Le trail dans l'île Gran Canaria est rude, d'une part car la température y est élevée et d'autre part car à part courir le long de la plage, partout ailleur le dénivellé se fait resentir à chaque parcours. Si vous aimez les grands dénivellés et le beau paysage, c'est l'endroit qu'il vous faut.</p>
          </article>

          <article class="infos_lieu">
            <h4>Autre sport au même lieu :</h4>
            <h5><a href="sport_randonee_bahia_membre.php" title="Randonnée"><i class="fas fa-hiking"></i></a></h5>
            <h4>Adresse</h4>
