...
<html lang="fr">
    <head>
        <meta charset="utf-8" />
        <title>TRAIL FERME LIBERT | BLUECOW®</title>
    ...
    <body>
      ...
      <h1 class="position">Le trail à la ferme Libert</h1>

      <main>
        <section class="conteneur_presen_sport">

          <article class="sport_detail" id="detail_lieu">
            <h2>Le trail à la ferme Libert,</h2><p>Les trails proposés à la ferme Libert sont généralement assez peu dificile, peu de dénivellé, mais cependant des parcours de plus de 30km sont proposés au plus courageux. Si vous voulez courir sans trop de difficulté c'est ce qu'il vous faut.</p>
          </article>

          <article class="infos_lieu">
            <h4>Autre sport au même lieu :</h4>
            <h5><a href="sport_randonee_libert_membre.php" title="Randonnée"><i class="fas fa-hiking"></i></a>
          ...
          <article class="sport_image">
            <img src="images/sport/randonnee_2.jpg" alt="Image de trail">
          </article>
          <article class="sport_image">
